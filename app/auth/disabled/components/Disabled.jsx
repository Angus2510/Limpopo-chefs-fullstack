  ...
  const getEmailInfo = () => {
    if (Reason === "Arrears Account") {
      return {
        ...
        message:
          "Your portal is currently blocked because of outstanding fees. This means that you are currently on-hold and can not attend classes. Please contact our finance department to settle your account.",
    ...
    <div className="flex h-full w-full items-center justify-center px-2 md:mx-0 md:px-0 lg:mb-10 lg:items-center lg:justify-start">
      <div className="mt-[10vh] w-full max-w-full flex-col items-center md:pl-4 lg:pl-0 xl:max-w-[420px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mb-9 ml-1 text-base text-gray-600">{message}</p>
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 w-full">
          ...
          <button
            onClick={() =>
              (window.location.href = `https://wa.me/27761912732?text=${encodeURIComponent(whatsappMessage)}`)
            }
